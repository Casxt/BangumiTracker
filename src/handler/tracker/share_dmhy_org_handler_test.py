...
def test__split_title():
    ...
    assert ShareDMHYTrackerHandler._split_title(string) == ['極影字幕·毀片黨', '我們的雨色協議', '第10集', 'BIG5', "AAC", 'AVC', '720p', "アンデットアンラック", "OP2", "&", "ED2", "ラブコール"]
...
def test__collecting_tag():
    ...
    assert tag_strs == ["喵萌奶茶屋&LoliHouse", "WEBRIP", "1080P", "HEVC", "10BIT", "AAC", "简繁日内封字幕", "320K", "FLAC"]
